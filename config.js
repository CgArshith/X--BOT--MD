...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "X BOT MD;𝛥𝑅𝑆𝛨𝛪𝑇𝛨;https://xenocdn.vercel.app/x/35666125/5oxv.jpeg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "X-BOT-MD;𝛥𝑅𝑆𝛨𝛪𝑇𝛨;https://xenocdn.vercel.app/x/35666125/5oxv.jpeg",
	...
	RENDER_API_KEY: process.env.RENDER_API_KEY || process.env.RENDER_KEY || "rnd_3ma9KFs4WSGghNtX3OJ2M2RWgrGu",
	RENDER_APP_NAME: process.env.RENDER_APP_NAME || process.env.RENDER_NAME || "arshith",
	...
	SESSION_ID: process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:4515ca8fe3ec7bac5875c8ec869c871e",
	START_MSG: toBool(process.env.START_MSG || "true"),
	STICKER_DATA: process.env.STICKER_DATA || `;𝛥𝑅𝑆𝛨𝛪𝑇𝛨`,
	SUDO: process.env.SUDO || "917907150233",
